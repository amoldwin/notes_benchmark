...
#                     default=['CHARTEVENTS', 'NOTEEVENTS', 'LABEVENTS', 'OUTPUTEVENTS'])
parser.add_argument('--event_tables', '-e', type=str, nargs='+', help='Tables from which to read events.',
                    default=['NOTEEVENTS'])
...
try:
    ...
    pass
notes = read_noteevents_table(args.mimic3_path)
...
#stays = merge_on_subject_admission(stays, notes)
...
if args.test:
    ...
    ##This breaks the validate_events.py assertion that duplicate icustay_ids are removed!
